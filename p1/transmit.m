...
function [bit_energy, symbol_energy, errors] = transmit (input_stream, modulation_levels, modulation_type, dbEbN0)
	...
	[recv_stream, bit_energy, symbol_energy] = awgn(modulated_stream, uint64(log2(double(modulation_levels))), uint64(dimension), complex, dbEbN0);
