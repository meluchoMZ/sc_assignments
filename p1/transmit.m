...
function [bit_energy, symbol_energy, errors, N0] = transmit (input_stream, modulation_levels, modulation_type, dbEbN0, ordering)
	% modulates input stream
	[modulated_stream, modulation, dimension, complex] = modulate(input_stream, modulation_levels, modulation_type, ordering);
	...
	output_stream = demodulate(recv_stream, modulation_levels, modulation_type, ordering);
